...
const val WORDS_VIEW_BODY: String =
    "SELECT 'core' AS source, id, word, translation, type, regular, forms, pronunciation, category, synonyms, antonyms, examples, tags, difficulty, status, level, favorite, notes, reviewCount, lastReview, nextReview, consecutiveCorrect, customDifficulty\n" +
        "        FROM core_words\n" +
        "        UNION ALL\n" +
        "        SELECT 'user' AS source, id, word, translation, type, regular, forms, pronunciation, category, synonyms, antonyms, examples, tags, difficulty, status, level, favorite, notes, reviewCount, lastReview, nextReview, consecutiveCorrect, customDifficulty\n" +
        "        FROM user_words"
// endregion
...
data class WordEntity(
    ...
    /**
     * Number of consecutive correct answers the user has produced for
     * this word in any mini-game. Reset to `0` on the next wrong
     * answer. Driven by
     * [data.game.AutoStatusEvaluator] — see [WordDao.setConsecutiveCorrect].
     */
