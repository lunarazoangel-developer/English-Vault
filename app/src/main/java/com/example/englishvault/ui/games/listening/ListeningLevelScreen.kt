 ...
 *
 * Renders in the arcade palette so the screen stays on-brand with
 * the rest of the UI: active cards swap to `palette.primary`,
 * inactive / locked cards fall back to `palette.surfaceDark`.
 */
@Composable
